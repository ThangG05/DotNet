...
namespace Motobike.Mathang
{
    public partial class Honda : Form
    {
        ...
        {
            string link = @"""D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\yahamaexciter.png""";
            Thongtinxe(link);
        }

        private void picyamaha2_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\yamahafreego.png";
            Thongtinxe(link);
        }

        private void picyamaha3_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\yamahajanus.png";
            Thongtinxe(link);
        }

        private void picyamaha4_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\yamahanvx.png";
            Thongtinxe(link);
        }
    }
}
