    ...
    public partial class Baocaohoatdongkinhdoanh : Form
    {
       ...
       private void ChartColum(string tencot)
       {
        ...
        private void ExportExcel(string path)
        {
            ...
            // Tạo biểu đồ
            Excel.Range dataRange = ws.Range["A1:B" + (row - 1)];
            Excel.ChartObjects charts = (Excel.ChartObjects)ws.ChartObjects();
            Excel.ChartObject chartObject = charts.Add(300, 50, 500, 300);
            Excel.Chart chart = chartObject.Chart;
            chart.SetSourceData(dataRange);
            chart.ChartType = Excel.XlChartType.xlColumnClustered;

            chart.HasTitle = true;
            chart.ChartTitle.Text = "Biểu đồ bán hàng";
