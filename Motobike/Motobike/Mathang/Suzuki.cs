...
namespace Motobike.Mathang
{
    public partial class Suzuki : Form
    {
        ...
        private void pícuzuki1_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\suzukiburgmanstreet.png";
            Thongtinxe(link);
        }

        private void picsuzuki2_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\suzukigsxr150.png";
            Thongtinxe(link);
        }

        private void pícuzuki3_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\suzukigsxs150.png";
            Thongtinxe(link);
        }

        private void picsuzuki4_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\suzukiraider.png";
            Thongtinxe(link);
        }
    }
}
