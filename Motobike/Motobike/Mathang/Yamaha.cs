...
namespace Motobike.Mathang
{
    public partial class Yamaha : Form
    {
        ...
        private void pichonda1_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\HONDAAIRBLADE.png";
            Thongtinxe(link);
            

        }

        private void pichonda2_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\hondapcx.png";
            Thongtinxe(link);
        }

        private void pichonda3_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\HONDASHMODE.png";
            Thongtinxe(link);
        }

        private void pichonda4_Click(object sender, EventArgs e)
        {
            string link = @"D:\ALL MON HOC\.NET\ShopMotobike\HangHoa\HONDAVISION.jpg";
            Thongtinxe(link);
        }
